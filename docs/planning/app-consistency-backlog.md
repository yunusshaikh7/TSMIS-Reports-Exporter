...
> v0.30.0 / v0.31.0 / v0.32.0. The one carried UX item (15 — the manual-compare day
> dropdown) is tracked in [docs/roadmap.md](../roadmap.md). This file remains the
> capture/triage record only.
