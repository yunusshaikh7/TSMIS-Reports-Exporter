...
| 2 | **RB-2** | HF-02 + HF-03 | The deliverable looks right and describes itself truthfully — **56 of the 68 denials** | None (RB-1 for the Clean Road witness) | `hotfix/rb-2-deliverable-presentation` | **REVIEW 1 APPROVED — AWAITING REVIEW 2** |
...
| **RB-2** | HF-02, HF-03 | 002, 003, 008, 009, 014, 016, 019 | 7 | **REVIEW 1 APPROVED — AWAITING REVIEW 2** |
...
verifier rejects missing or mismatched exact heads. Resume Prompt 05 in a
separate fresh task for Review 2; do not merge before Review 2 approves.
