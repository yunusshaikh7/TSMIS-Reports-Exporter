...
| 5 | **RB-5** | HF-06 + HF-09 | Difference classification — the two opposite rulings applied to the right classes | RB-1, RB-2 | `hotfix/rb-5-difference-classification` | **REVIEW 1 APPROVED — AWAITING REVIEW 2** (returned twice — `RB5-R1-EG-001` evidence, `RB5-R1-001` defect; both answered) |
...
| **RB-5** | HF-06, HF-09 | 011, 013 | 2 | **REVIEW 1 APPROVED — AWAITING REVIEW 2** |
