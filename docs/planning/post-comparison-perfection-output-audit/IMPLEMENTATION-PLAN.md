...
| 3 | **RB-3** | HF-04 | Ramp Detail — restores 9 comparison placements that produce nothing today | None | `hotfix/rb-3-ramp-detail-layout` | **REVIEW 1 APPROVED — AWAITING REVIEW 2** |
...
| **RB-3** | HF-04 | 001, 012 | 2 | **REVIEW 1 APPROVED — AWAITING REVIEW 2** |
...
approved; begin Review 2 only in a separate fresh task against the pushed
approval head.
