...
| 3 | **RB-3** | HF-04 | Ramp Detail — restores 9 comparison placements that produce nothing today | None | `hotfix/rb-3-ramp-detail-layout` | **JOINTLY APPROVED** |
...
| **RB-3** | HF-04 | 001, 012 | 2 | **JOINTLY APPROVED** |
...
RB-3 is jointly approved and entering the Prompt-05 merge sequence.
