...
| 4 | **RB-4** | HF-05 + HF-10 | Evidence, end to end — **AMENDED by the owner 2026-08-05 and 2026-08-09**: print crops on the four `_pdf` report families only; anchorless blanks from the print's own cell geometry are disclosed limitations | None | `hotfix/rb-4-evidence` | **REVIEW 1 APPROVED — AWAITING REVIEW 2** (re-reviewed through `14475ff`) |
...
| **RB-4** | HF-05, HF-10 | 004, 005, 006, 007 | 4 | **REVIEW 1 APPROVED — AWAITING REVIEW 2** |
...
RB-4 is **REVIEW 1 APPROVED — AWAITING REVIEW 2**. Run Prompt 05 in a fresh
task; do not merge until Review 2 independently approves.
