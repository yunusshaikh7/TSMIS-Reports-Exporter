...
| 11 | Family identity/loader/parser/provenance remediation | **Deferred / next implementer** | Integrate the accepted typed identity and source maps one family at a time; every known red fixture must turn green |
