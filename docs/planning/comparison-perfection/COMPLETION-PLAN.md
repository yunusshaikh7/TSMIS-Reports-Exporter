...
| **Findings** | **241 total · ~170 CLOSED (Resolved/Remediated) · ~10 partial · ~60 open** (~71% closed by count; the correctness-critical core is done, the open tail is hardening + non-product instrument work). **Buckets:** A ✅ · **C ✅ COMPLETE** (028/029/030/031/032/033/034/036/063/027 + 070-not-a-defect) · **D ✅ COMPLETE** (018 ✅ · 019 ✅ · 046 ✅ · 022 ✅) · B/E/F/G/H/I 🔨 (071 ✅ route-universe · 068 ✅ HD Report View · 069 ✅ RD PDF roles · 015 ✅ TSAR label fix · 064 ✅ PDF anomaly counts · 038 ✅ date normalizer · 009 ✅ numeric key parity; parser robustness / matrix-GUI lifecycle / evidence arc / source-semantics / instrument hardening / trivia) |
...
> ### ▶ RESUME HERE (2026-07-18, after 009 + 038 + 022 (C&D done) + 071 + 068 + 069 + 015 + 064 — buckets B/E/G/H/I)
>
> **NEXT tractable non-UI: 039 + 043 (the shared `summary_layout._render` slice).** 039's
> Report View slice is already remediated; the OPEN remainder is the Ramp/Intersection
> `Summary by Category` extra sheet — `_render`/`value_row` re-derives equality from a numeric
> delta and can go stale after a live-formulas recalc (043). Make it consume typed comparison
> state / carry an unmistakable snapshot label + a live aggregate invariant like the Report
> View slice did (043 acceptance wants an installed-Excel recalc gate — budget for COM).
>
