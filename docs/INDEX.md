...
| [planning/comparison-perfection/README.md](planning/comparison-perfection/README.md) | You want to know **why a comparison behaves the way it does**. The comparison-perfection project's record — **COMPLETE, shipped as v0.28.0**; as of v0.37.0 **239/243 closed, 4 open** (133 · 142 · 186 + 045-HD — the HD pre-release block was LIFTED by the vendor's 2026-08-17 release, so all four are actionable). Audit ledgers, source bindings, canary bindings and advisory reviews in one folder. It is a record, not a worklist. |
