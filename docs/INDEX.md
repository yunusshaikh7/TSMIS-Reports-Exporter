...
| [work-pc-validation.md](work-pc-validation.md) | You're closing out the **v0.18.1** field validation — the credential-safe `--collect-evidence` kit, the manual fallback, the §K2 work-PC acceptance checklist, and the v0.18.1 close-out plan. (The two-tier model: v0.18.0 = offline candidate, v0.18.1 = field-validated sign-off.) |
