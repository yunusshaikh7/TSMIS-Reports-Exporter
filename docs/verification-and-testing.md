...
| `check_consolidate_intersection.py` | **Intersection Detail consolidator** (v0.17.0): config (subdir/sheet/filename), 2-route end-to-end consolidation, leading Route column |
