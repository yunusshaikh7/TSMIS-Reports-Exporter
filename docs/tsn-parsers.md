...
- **Counts (CANARY — TSMIS `2026-08-17 ssor-prod` vs the 09/15/2025 print):** TSN normalized **92 categories** (91 + the total; the masked one omitted) vs TSMIS 95 → **92 in both / 4 only-TSMIS / 0 only-TSN; 89 differing, 3 identical**. ⚠ **Mind the vintage:** the two sources are ~11 months apart, so the 89 is dominated by real network change, not defect. A near-same-date print is tracked as an open ask.
