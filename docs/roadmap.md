...
>    rule.
> 5. **DA4 — the other reports rendered from the layers.** Highway Detail proved
>    the recipe; the next one should be a mapping table, not a second engine.
>
...
## ▣ OPEN WORK INVENTORY (current as of v0.42.1, 2026-08-31)
