...
def test_enumeration():
    ...
    try:
        ...
        check("ten comparable rows — every report (both HL + both Intersection + "
              "both Highway Detail formats, v0.20.0)",
        ...
        check("hidden row dropped from rows",
              "highway_log" not in hidden_snap["rows"] and len(hidden_snap["rows"]) == 9)
