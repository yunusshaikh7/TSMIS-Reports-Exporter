...
def _readme_text():
    ...
    lines += [
        ...
        "",
        "OPTIONAL: highway_detail/pdf/ — drop the TSN Highway Detail DISTRICT",
        "PDFs there (any filenames) to enable the 'Evidence images' option on",
        "the comparison pages: sampled differences rendered as highlighted",
        "snippets from both the TSMIS and TSN printed pages.",
        "",
        "This note is ignored by the app and is safe to delete.",
    ]
    return "\n".join(lines) + "\n"
