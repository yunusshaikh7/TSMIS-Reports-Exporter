...
REPORT_LABEL = "TSAR: Ramp Detail"
OUT = OUTPUT_ROOT / "ramp_detail"
...
def main():
    ...
    print("=" * 60)
    print(f"TSMIS Ramp Detail Bulk Export — {len(ROUTES)} routes")
    print("=" * 60)
    print()
    ...
    with sync_playwright() as p:
        ...
        for i, route in enumerate(ROUTES, 1):
            out_path = OUT / f"tsar_ramp_detail_route_{route}.xlsx"
