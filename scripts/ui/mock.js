  ...
  return {
    get_initial_state: async () => ({
      ...
      compare_reports: [
        ...
        { key: "cmp:intersection_detail:tsn", label: "TSAR: Intersection Detail — TSMIS vs TSN", kind: "files", group: "tsn", family_group: "Intersection", subdir: null, file_a_label: "TSMIS", file_b_label: "TSN" },
