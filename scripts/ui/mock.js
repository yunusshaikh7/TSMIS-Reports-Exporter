  ...
  const mockApi = {
    get_initial_state: async () => ({
      ...
      compare_reports: [
        ...
        { key: "cmp:highway_log:pdf_vs_excel", label: "Highway Log — TSMIS (PDF) vs TSMIS (Excel)", kind: "files", group: "self", family_group: null, subdir: null, file_a_label: "TSMIS (PDF)", file_b_label: "TSMIS (Excel)" },
        ...
        { key: "cmp:highway_sequence:pdf_vs_tsn", label: "Highway Sequence Listing — TSMIS (PDF) vs TSN", kind: "files", group: "tsn", family_group: null, subdir: null, file_a_label: "TSMIS (PDF)", file_b_label: "TSN" },
        { key: "cmp:highway_sequence:pdf_vs_excel", label: "Highway Sequence Listing — TSMIS (PDF) vs TSMIS (Excel)", kind: "files", group: "self", family_group: null, subdir: null, file_a_label: "TSMIS (PDF)", file_b_label: "TSMIS (Excel)" },
        ...
        { key: "cmp:ramp_detail:pdf_vs_excel", label: "TSAR: Ramp Detail — TSMIS (PDF) vs TSMIS (Excel)", kind: "files", group: "self", family_group: "Ramp", subdir: null, file_a_label: "TSMIS (PDF)", file_b_label: "TSMIS (Excel)" },
        ...
        { key: "cmp:intersection_summary:tsn", label: "Intersection Summary — TSMIS vs TSN", kind: "files", group: "tsn", family_group: "Intersection", subdir: null, file_a_label: "TSMIS", file_b_label: "TSN" },
        ...
        { key: "cmp:intersection_detail:tsn", label: "Intersection Detail — TSMIS vs TSN", kind: "files", group: "tsn", family_group: "Intersection", subdir: null, file_a_label: "TSMIS", file_b_label: "TSN" },
        ...
        { key: "cmp:intersection_detail:pdf_vs_excel", label: "Intersection Detail — TSMIS (PDF) vs TSMIS (Excel)", kind: "files", group: "self", family_group: "Intersection", subdir: null, file_a_label: "TSMIS (PDF)", file_b_label: "TSMIS (Excel)" },
        ...
        { key: "cmp:highway_detail:pdf_vs_excel", label: "Highway Detail — TSMIS (PDF) vs TSMIS (Excel)", kind: "files", group: "self", family_group: "Highway", subdir: null, file_a_label: "TSMIS (PDF)", file_b_label: "TSMIS (Excel)" },
